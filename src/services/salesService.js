...
export function registrarVenta(datos, clienteId, productoNombre, cantidad, precioUnitarioUSD, tasa) {
    ...
    const factura = crearFactura(datos, transaccion, cliente.nombre, cliente.rif);
    guardarDatos(datos);
